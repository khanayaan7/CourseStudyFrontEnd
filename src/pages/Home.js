      ...
      text-white justify-between'>
            ...
            <div>
                <CodeBlocks 
                    ...
                    codeblock={`<!DOCTYPE html>\n<html lang="en">\n<head>\n<title>This is made By Ayaan Khan</title>\n</head>\n<body>\n<h1><a href="/">Header</a></h1>\n<nav> <a href="/one">One</a> <a href="/two">Two</a> <a href="/three">Three</a></nav>\n</body>`}
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-5 mb-10 -mt-20 lg:mt-[95px]'>
                    ...
                    <div className='flex flex-col gap-10 lg:w-[40%] items-start'>
                        ...
                        The modern CourseStudy dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                        </div>
                        <CTAButton active={true} linkto={"/signup"}>
                            <div>
                                Learn more
